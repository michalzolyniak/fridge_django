...
from fridge_management.views import \
    ...
    FridgeRemoveProductView, FridgeWasteView, FridgeEatenProductsView, OpenProductView
...
urlpatterns = [
    ...
    path('open_product/<int:record_id>/', OpenProductView.as_view(), name='open_product'),
]
